        ...
        <div className={`${color === "dark" ? "fondo_animado_oscuro" : "fondo_animado_claro"}  grid h-screen w-full animate-backanimado items-center text-center`}>
            <div className="animate-text-focus-in">
                ...
                >
                    ...
                    <span className="block border border-rose-600 bg-rose-600 px-12 py-3 transition-transform active:border-rose-500 active:bg-rose-500 group-hover:-translate-x-1 group-hover:-translate-y-1">
                    Conocer Perfil
                    </span>
                </Link>
            </div>
