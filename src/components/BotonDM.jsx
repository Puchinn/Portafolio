        ...
        peer-checked:[&>.last]:opacity-30 peer-checked:[&>.last]:bg-transparent peer-checked:[&>.last]:shadow-none">
                ...
                <div className="px-2 py-1 bg-white rounded shadow last">
                    <svg width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path 
                        d="M12 6V3M12 6C8.6863 6 6 8.68629 6 12M12 6C15.3137 6 18 8.68629 18 12M18 12H21M18 12C18 15.3137 15.3137 18 12 18M16.2426 7.75736L18.364 5.63604M12 21V18M12 18C8.6863 18 6 15.3137 6 12M3 12H6M5.63605 18.364L7.75737 16.2426M16.2426 16.2424L18.364 18.3638M5.63607 5.636L7.75739 7.75732" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        />
                    </svg>
                </div>
            </div>
